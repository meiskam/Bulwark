...
This mechanism has been integrated into Bitcore-Node-BMTP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BMTP-Project/insight-api-bmtp#web-socket-api](https://github.com/BMTP-Project/insight-api-bmtp#web-socket-api) 
* API: [https://github.com/BMTP-Project/insight-api-bmtp#swifttx-transactions](https://github.com/BMTP-Project/insight-api-bmtp#swifttx-transactions) 
...
By default, the BMTP Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BMTP Core daemon:
