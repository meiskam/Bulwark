...
In order to support loading of multiple wallets in bmtp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bmtp.cpp.
...
Changes to bmtp.cpp
----------------------
bmtp.cpp is the entry point into bmtp-qt, and as such, will require some minor modifications to provide hooks for
