...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue bwkzObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        bwkzObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    bwkzObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("BWKzsupply", bwkzObj));
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"BWKzsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 BWKz denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 BWKz denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 BWKz denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 BWKz denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 BWKz denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 BWKz denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 BWKz denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 BWKz denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all BWKz denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"bwkaddress\"   	 	(string) bulwark address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
