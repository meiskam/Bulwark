...
public:
    ...
    void setBWKZControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintBWKZ_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendBWKZ_clicked();
    void on_pushButtonBWKZControl_clicked();
