                               ...
                               const CAmount& watchImmatureBalance)
{
    ...
    ui->labelzAvailableAmount_2->setText(QString::number(zerocoinBalance/COIN) + QString(" zBWK "));
    ui->labelzBWKAmountValue->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, balance - immatureBalance, false, BitcoinUnits::separatorAlways));
}
