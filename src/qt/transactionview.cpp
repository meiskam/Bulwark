 ...
 */
    ...
    typeWidget->addItem(tr("Received BWK from BWKz"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in BWKz"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_BWKZ));
