                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BMTP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BMTP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bmtp: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BMTP Core"), this);
    aboutAction->setStatusTip(tr("Show information about BMTP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BMTP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BMTP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BMTP addresses"));
    ...
    openAction->setStatusTip(tr("Open a BMTP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BMTP Core help message to get a list with possible BMTP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BMTP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BMTP network", "", count));
}
...
{
    QString strTitle = tr("BMTP Core"); // default title
