...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bmtp features */
        {"bmtp", "masternode", &masternode, true, true, false},
        {"bmtp", "listmasternodes", &listmasternodes, true, true, false},
        {"bmtp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bmtp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bmtp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bmtp", "masternodedebug", &masternodedebug, true, true, false},
        {"bmtp", "startmasternode", &startmasternode, true, true, false},
        {"bmtp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bmtp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bmtp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bmtp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bmtp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bmtp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bmtp", "mnbudget", &mnbudget, true, true, false},
        {"bmtp", "preparebudget", &preparebudget, true, true, false},
        {"bmtp", "submitbudget", &submitbudget, true, true, false},
        {"bmtp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bmtp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bmtp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bmtp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bmtp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bmtp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bmtp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bmtp", "checkbudgets", &checkbudgets, true, true, false},
        {"bmtp", "mnsync", &mnsync, true, true, false},
        {"bmtp", "spork", &spork, true, true, false},
        {"bmtp", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bmtp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bmtpd, or the -server option to bmtp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bmtp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42108sudo apt install regexxer/\n";
}
