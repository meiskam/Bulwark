...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bmtp Core bmtp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bmtp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bmtp transaction") + "\n" +
                               "  bmtp-tx [options] -create [commands]   " + _("Create hex-encoded bmtp transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bmtp transaction
