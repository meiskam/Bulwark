...
RESOURCES += src/qt/bmtp.qrc src/qt/bmtp_locale.qrc

TRANSLATIONS += src/qt/locale/bmtp_bg.ts \
                src/qt/locale/bmtp_de.ts \
                src/qt/locale/bmtp_en.ts \
                src/qt/locale/bmtp_es.ts \
                src/qt/locale/bmtp_fi.ts \
                src/qt/locale/bmtp_fr.ts \
                src/qt/locale/bmtp_it.ts \
                src/qt/locale/bmtp_ja.ts \
                src/qt/locale/bmtp_pl.ts \
                src/qt/locale/bmtp_pt.ts \
                src/qt/locale/bmtp_ru.ts \
                src/qt/locale/bmtp_sk.ts \
                src/qt/locale/bmtp_sv.ts \
                src/qt/locale/bmtp_vi.ts \
                src/qt/locale/bmtp_zh_CN.ts \
                src/qt/locale/bmtp_zh_TW.ts
