Contributing to BMTP Core
============================

The BMTP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BMTP Core project, and is not to be
confused with overall BMTP Network Protocol consensus changes.

Whether a pull request is merged into BMTP Core rests with the project merge
...
Patches that change BMTP consensus rules are considerably more involved than
...
Where a patch set proposes to change the BMTP consensus, it must have been
...
The project leader is the release manager for each BMTP Core release.
